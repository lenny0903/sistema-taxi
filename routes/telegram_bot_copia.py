...
def webhook():
    ...
    try: 
        ...
        # 2. PROCESAMIENTO DE TEXTO PRIMERO (Permite que no registrados envíen /start o código Bxx)
        if 'text' in msg: 
            texto = msg['text'] 
        ...
        # 3. BUSCAR AL CONDUCTOR (Exclusivo para funciones de ubicación o interacciones avanzadas)
